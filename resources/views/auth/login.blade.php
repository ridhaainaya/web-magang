<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <x-text-input id="email" class="block mt-1 w-full placeholder:text-sm placeholder:text-gray-400" type="email" name="email" :value="old('email')" required autofocus placeholder="Contoh: andixxx@gmail.com" />
        ...
        <div class="mt-4">
            ...
            <div class="relative mt-1">
                ...
                <button type="button" onclick="togglePassword()" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-indigo-600">
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            @if (Route::has('password.request'))
                <a class="text-sm text-gray-600 hover:text-indigo-600 underline underline-offset-4 decoration-gray-300" href="{{ route('password.request') }}">
                    Lupa password?
                </a>
            @endif
        </div>
        ...
        <div class="flex flex-col items-center justify-center mt-8 space-y-4">
            ...
            <p class="text-sm text-gray-600">
                Belum punya akun? 
                <a class="font-semibold text-indigo-600 hover:text-indigo-800 transition" href="{{ route('register') }}">
                    Daftar di sini
                </a>
            </p>
        </div>
